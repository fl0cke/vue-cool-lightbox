    ...
    <div class="cool-lightbox" 
      ...
      <div 
        ...
        <div class="cool-lightbox__navigation">
          <button type="button" class="cool-lightbox-button cool-lightbox-button--prev" title="Zurück" :class="buttonsClasses" v-show="(hasPreviousButton || loopData) && items.length > 1" @click="onPrevClick">
          ...
          <button type="button" class="cool-lightbox-button cool-lightbox-button--next" title="Weiter" :class="buttonsClasses" v-show="(hasNextButton || loopData) && items.length > 1" @click="onNextClick(false)">
            <slot name="icon-next">
              <div class="cool-lightbox-button__icon">
        ...
        <div class="cool-lightbox-toolbar" :class="buttonsClasses">
          ...
          <button type="button" v-if="this.slideshow && items.length > 1" title="Starte slideshow" class="cool-lightbox-toolbar__btn" @click="togglePlaySlideshow">
          ...
          <button type="button" @click="showThumbs = !showThumbs" title="Zeige thumbnails" v-if="items.length > 1 && gallery" class="cool-lightbox-toolbar__btn">
   	  ...
   	  <button type="button" v-if="showDeleteButton" class="cool-lightbox-toolbar__btn" title="Löschen" @click="delete">
            <slot name="close">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		...
		<path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/>
          ...
          <button type="button" v-if="showCloseButton" class="cool-lightbox-toolbar__btn" title="Schließen" @click="close">
            <slot name="close">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export default {
  ...
  methods: {
    ...
    delete() {
      this.$emit("delete", this.imgIndex);
    }
